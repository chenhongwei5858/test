...
//值为该商品的url
$product_url="product_detail2.php";
				...
				<form name="purchase" action="cart.php?product=<?php echo $product_url; ?>" method="post">
					<div class="product_show_module">
						<div class="photo_show">
							<div class="sliderBox">
					            <ul class="slider">
					                <li><a href=""><img src="images/temp/product2/480x480.jpg"></a></li>
					            </ul>    
					        </div>
					        <ul class="control">
					            <li><img src="images/temp/product2/60x60.jpg"></li>
					        </ul>
						</div>
				...
				<div class="des_content tab_content">
					<div class="tab_con">
						<div class="des_item product_description tab_conItem">
							<img src="images/temp/product2/size.png" alt="description">
						</div>
