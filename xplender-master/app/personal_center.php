...
//每页显示订单行数
$order_pageSize=5;
$order_page_index=@$_REQUEST['page']?(int)$_REQUEST['page']:1;
$order_rows=getProductPage($order_page_index,$order_pageSize,"xplender_order","customer_id='{$customer_id}'");
	...
	<table class="" border='1'>
        ...
        <tbody>
			...
			<?php if($order_rows>$pageSize):?>
				<tr>
					<td colspan="10" class="no-padding-right"><?php echo showPage($order_page_index,$totalPage);?></td>
				</tr>
			<?php endif;?>                   
        </tbody>
    </table>
